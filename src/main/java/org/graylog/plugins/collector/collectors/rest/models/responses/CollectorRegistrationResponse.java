...
public abstract class CollectorRegistrationResponse {
    ...
    @JsonCreator
    public static CollectorRegistrationResponse create(@JsonProperty("update_interval") int updateInterval,
                                                       @JsonProperty("send_status") boolean sendStatus) {
        return new AutoValue_CollectorRegistrationResponse(updateInterval, sendStatus);
    }
}
