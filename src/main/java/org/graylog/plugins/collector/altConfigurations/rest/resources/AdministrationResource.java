...
public class AdministrationResource extends RestResource implements PluginRestResource {
    ...
    @Inject
    public AdministrationResource(AltCollectorService collectorService,
        ...
        this.searchQueryParser = new SearchQueryParser(Collector.FIELD_NODE_NAME, AltCollectorResource.SEARCH_FIELD_MAPPING);
    }
